...
@section('user')
    ...
    <div class="page-header breadcrumb-wrap">
        <div class="container">
            <div class="breadcrumb">
                ...
                <span></span> Stripe Delivery Payment
            </div>
        </div>
    </div>
    <div class="container mb-80 mt-50">
        <div class="row">
            <div class="col-lg-8 mb-40">
                <h3 class="heading-2 mb-10"> Stripe Delivery</h3>
    ...
    <script type="text/javascript">
        ...
        var stripe = Stripe('pk_test_51NWMDZLri2wDpNOf88wzitIvQryriW4QuxJ2Aqp7Dh5bgshOzLdt1tmVdrLW37bylGOWSpUedkehmXOuLDtwNFMs008ToNcGNs');
