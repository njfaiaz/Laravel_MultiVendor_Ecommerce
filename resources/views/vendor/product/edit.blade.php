...
@section('vendor')
    ...
    <div class="page-content">
        ...
        <div class="card">
            <div class="card-body p-4">
                ...
                <hr />
                <form id="myForm"  action="{{ route('vendor.product.update') }}" method="POST">
                    @csrf
    ...
    <!--end page wrapper -->
        ...
        <div class="page-content">
            ...
            <hr>
            <div class="card">
                <form id="myForm"  action="{{ route('vendor.product.mainImage.update') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="id" value="{{ $product->id }}">
            ...
            <div class="card">
                <div class="card-body">
                    <table class="table mb-0">
                        ...
                        <tbody>
                            <form id="myForm"  action="{{ route('vendor.product.multiImage.update') }}" method="POST" enctype="multipart/form-data">
                                @csrf
