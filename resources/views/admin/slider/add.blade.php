            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">New Slider Add</li>
                    </ol>
                </nav>
            </div>
        </div>
                                ...
                                <div class="card-body">
                                    <div class="row mb-3">
                                        ...
                                        <div class="form-group col-sm-9 text-secondary">
                                            <input type="text" name="slider_title" class="form-control" placeholder="Enter Your Slider Title"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="form-group col-sm-9 text-secondary">
                                            <input type="text" name="slider_short_title" class="form-control" placeholder="Enter Your Slider Short Title" />
                                        </div>
                                    </div>
