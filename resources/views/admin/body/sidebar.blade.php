<div class="sidebar-wrapper" data-simplebar="true">
    ...
    <ul class="metismenu" id="menu">
        ...
        <li>
            ...
            <ul>
                <li> <a href="{{ route('admin.blog.category') }}"><i class="bx bx-right-arrow-alt"></i>All Blog Categroy</a></li>
        ...
        <li>
            ...
            <ul>
                <li> <a href="{{ route('pending.review') }}"><i class="bx bx-right-arrow-alt"></i>All Pending Review</a></li>
                <li> <a href="{{ route('publish.review') }}"><i class="bx bx-right-arrow-alt"></i>All Publish Review</a></li>
            </ul>
        </li>
        ...
        <li>
            ...
            <ul>
                <li> <a href="{{ route('seo.setting') }}"><i class="bx bx-right-arrow-alt"></i>Admin Seo Setting</a></li>
            </ul>
        </li>
        ...
        <li>
            ...
            <ul>
                <li> <a href="{{ route('product.stock') }}"><i class="bx bx-right-arrow-alt"> Product Stock</i></a></li>
            </ul>
        </li>
        ...
        <li>
            ...
            <ul>
                <li> <a href="{{ route('site.setting') }}"><i class="bx bx-right-arrow-alt"></i>Admin Setting</a></li>
            </ul>
        </li>
        ...
        <li>
            ...
            <ul>
                ...
                <li> <a href="{{ route('add.roles.permission') }}"><i class="bx bx-right-arrow-alt"></i>Permission &  Roles</a></li>
                <li> <a href="{{ route('all.roles.permission') }}"><i class="bx bx-right-arrow-alt"></i>All Permission &  Roles</a></li>
            </ul>
        </li>
